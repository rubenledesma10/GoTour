...
const tourist_site = document.querySelectorAll('[data-role="tourist_site"]'); //accedemos al permiso
...
const touristSiteLink = document.querySelectorAll('[data-role="tourist_site"]'); //accedemos al permiso
